...
public class BigIntegerDemo {
    public static void main(String[] args) {
        ...
        System.out.println("der Datentyp Long kann Werte zwischen " + minValueLong + " und " + maxValueLong + " speichern");
        ...
        for (BigInteger i = BigInteger.ONE; i.compareTo(BigInteger.valueOf(70)) <= 0; i = i.add(BigInteger.ONE)) {
            ...
            System.out.println("i=" + i + ", power=" + powerBigInteger);
        }
    }
