 ...
 * and printing. <br>
 * Printing is supported by static functions printMessage and printErrorMessage
 * <br>
 ...
 * any) <br>
 * - error message and repeated input request are generated if input is not IN
...
public class Console {
	...
	/**
	 * Displays prompt and returns token read from console Expects exactly one
	...
	/**
	 * Displays prompt and returns <code>boolean</code>-value depending of yes/no
	 * answer
	 * 
